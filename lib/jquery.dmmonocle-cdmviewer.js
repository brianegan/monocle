...
(function($){
	 ...
	 */
	DmMonocle = function(options, elem) {
	 ...
	 *  
	 */
	DmMonocle.prototype.constructMenu = function() {
	 ...
	 * 
	 */
	DmMonocle.prototype.constructImage = function() {
	 ...
	 * @public
	 */
	DmMonocle.prototype.constructZoomImage = function() { 
		var zoomImage =  "<div class=\"dmMonocle-zoomImage\"><img src=\"" + this.options.urlPrefix + "/cgi-bin/getimage.exe?CISOROOT=" + this.options.CISOROOT + "&CISOPTR=" + this.options.CISOPTR + "&DMSCALE=" + (this.zoomImage.zoom * 100) + "&DMWIDTH=" + this.zoomImage.dim.width + "&DMHEIGHT=" + this.zoomImage.dim.height + "&DMROTATE=" + this.viewer.rotation + "\" /></div>"
	 ...
	 * @public
	 */
	DmMonocle.prototype.constructThumbnail = function() {
   ...
   * @param Object el The element 
	...
	function calcViewerDimensions(monocle) {
		return { width: monocle.elem.width(), height: monocle.elem.height() }
	}
